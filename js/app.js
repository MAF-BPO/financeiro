...
function validateForm() {
  ...
  // Enviar com EmailJS
  emailjs.send("service_j0wlzb6", "template_5lgh4v9", {
    from_name: name,
    from_email: email,
    subject: subject,
    message: comments
  ...
  .then(function(response) {
    document.getElementById("simple-msg").innerHTML = "<div class='alert alert-success'>Mensagem enviada com sucesso!</div>";
    document.forms["myForm"]["name"].value = "";
    document.forms["myForm"]["email"].value = "";
    document.forms["myForm"]["subject"].value = "";
    document.forms["myForm"]["comments"].value = "";
  }, function(error) {
    document.getElementById("simple-msg").innerHTML = "<div class='alert alert-danger'>Erro ao enviar. Tente novamente mais tarde.</div>";
